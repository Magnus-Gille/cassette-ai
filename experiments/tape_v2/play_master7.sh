#!/bin/bash
# Play master7.wav (MERGED m5 + m6 ladder) at volume 75 with a live progress bar.
# 9 rungs in ONE recording: 4× WS_M16 RS-ladder + 5× WS_M32 turbo geometry.
#
# Usage:  bash experiments/tape_v2/play_master7.sh
# Start your deck RECORDING first, then run this (it gives a 3s lead-in).

WAV="/Users/magnus/repos/cassette-ai/experiments/tape_v2/master7.wav"
...
echo "master7.wav — MERGED m5+m6 ladder — $((DUR/60))m $((DUR%60))s."
echo "  M16 rungs: RS(255,111/159/191/223)   M32 turbo: RS(255,95/111/127/159/191)"
