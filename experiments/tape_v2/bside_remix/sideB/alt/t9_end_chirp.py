...
OUT = "/Users/magnus/repos/cassette-ai/experiments/tape_v2/bside_remix/sideB/alt/t9.wav"
...
# ALT: gentle dip at ~84-87 s (listener found the drone a bit intense at 1:24).
# Peak 1.0 holds until 80 s, dips to 0.80 (-2 dB) at 84-87 s, recovers by 92 s.
chord_arc = ramp_env([0, 20, 60, 80, 84, 87, 92, 110, 150, 168, DUR],
                     [0.0, 0.55, 1.0, 1.0, 0.80, 0.80, 1.0, 1.0, 0.85, 0.6, 0.45])
