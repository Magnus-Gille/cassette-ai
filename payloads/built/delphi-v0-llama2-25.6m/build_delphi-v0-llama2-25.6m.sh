#!/usr/bin/env bash
# Reproduce the tape-ready int4 bundle for delphi-suite/v0-llama2-25.6m (Platinum).
# License: MIT (HF cardData/tag). ship_clear.
set -euo pipefail
cd "$(git rev-parse --show-toplevel)"
REPO="delphi-suite/v0-llama2-25.6m"
DST="payloads/built/delphi-v0-llama2-25.6m"
