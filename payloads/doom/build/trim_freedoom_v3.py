...
def main():
    ...
    ap.add_argument("--out", default=HERE + "/freedoom_e1_v3.wad")
    ...
    if args.sfx_mode == "real":
        ...
        for nm in USED_SFX:
            ...
            real_sfx[nm] = downsample_dmx(buf, args.sfx_rate_cap)
    ...
    if args.sfx_mode == "real":
        print(f"sfx: {len(USED_SFX)} real (rate-cap {args.sfx_rate_cap or 'off'}, "
              f"alias level {args.sfx_alias_level}) {sfx_raw_in/1024:.1f} -> "
